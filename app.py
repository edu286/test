...
# ── 1. 수업 제목 ──
st.title("역학적 에너지")  # ← 교과별 제목으로 자유롭게 수정하세요.
...
# ── 3‑3. 서술형 문제 3 표시 ──
QUESTION_3 = """
운동 에너지와 위치 에너지를 이용하여 역학적 에너지에 대해 설명하시오.
"""
...
# ── 1. 문항별 채점 기준 (교사가 수정) ──
GRADING_GUIDELINES = {
    1: "운동 에너지는 움직이는 물체가 가지고 있는 에너지이다.",
    2: "위치 에너지는 기준면에 대해 높이를 가지고 있는 물체가 가지고 있는 에너지이다",
    3: "역학적 에너지는 운동 에너지와 위치 에너지를 더한 값으로, 운동 에너지가 증가하면 위치 에너지는 감소하고, 위치 에너지가 증가하면 운동 에너지는 감소한다."
}
